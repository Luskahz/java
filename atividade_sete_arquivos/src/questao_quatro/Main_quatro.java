...
public class Main_quatro {
    public static void main(String[] args) {
        ...
        Contato c = agenda.lerContatoPorNome("João Silva", "C:\\Users\\lucas\\OneDrive\\Documentos\\NetBeansProjects\\atividade_sete_arquivos\\src\\questao_tres\\agenda_contatos.txt");
        agenda.removerContato("joao silva");
        System.out.println("\nContatos após remoção:");
        agenda.visualizarContatos();
        agenda.salvarAgenda("C:\\Users\\lucas\\OneDrive\\Documentos\\NetBeansProjects\\atividade_sete_arquivos\\src\\questao_tres\\agenda_contatos.txt");
